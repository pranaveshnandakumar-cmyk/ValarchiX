...
async function testGroqDirectSpeed() {
  console.log("=== TESTING GROQ LLAMA-3.1-8B-INSTANT DIRECT SPEED ===");
  ...
  try {
    ...
    console.log(`\n⚡ INSTANT BLAZING GROQ SPEED SUCCESS! (${elapsed}s)`);
    ...
    console.error("❌ Groq Direct Speed Failed:", err.message || err);
  }
}
